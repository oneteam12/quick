...
<head>
    ...
    <link href="app/css/cu/fileinput.css" type="text/css" rel="stylesheet" />
    <%--<link href="app/css/cu/fileinput-rtl.css" type="text/css" rel="stylesheet" />--%>
...
<div class="mainBox"
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0"
        ...
        <tr>
            ...
            <td width="55%"  align="center">水系表模板.xls</td>

            <td width="15%" align="center">
                <a type="button" class="btnz btnz-info" id="download" href="download/mike/水系表模板.xls"  readonly=""><i class='glyphicon glyphicon-download'></i>下载</a>
            </td>
...
<script type="text/javascript" src="app/js/mike/bulkImportShuiXi.js"></script>
